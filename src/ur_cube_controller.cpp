...
private:
    void handle_command(const std_msgs::msg::String::SharedPtr msg) {
        ...
        if (cmd == "UM") {
            ...
            task_queue_.push({ActionType::GRIPPER, {}, true, 0.0});
            task_queue_.push({ActionType::MOVE, {-3.141767186515, -1.8181094818025, -1.4114477660878, -1.4830062654196, 1.5707963267949, 1.6057029118348}, false, 0.5});
            ...
            task_queue_.push({ActionType::MOVE, {0.0, -1.57, 1.0, -1.0, 1.57, 0.0}, false, 1.0});
            task_queue_.push({ActionType::MOVE, {0.0, -1.57, 1.0, -1.0, 1.57, -1.57}, false, 2.0});
            task_queue_.push({ActionType::MOVE, {0.0, -1.57, 0.0, 0.0, 0.0, 0.0}, false, 3.0});
        }
        else if (cmd == "X'") {
            // Tu secuencia de pinza + trayectorias con tiempos personalizados
            task_queue_.push({ActionType::GRIPPER, {}, true, 0.0});
            task_queue_.push({ActionType::MOVE, {-3.141767186515, -1.8181094818025, -1.4114477660878, -1.4830062654196, 1.5707963267949, 0.034906585039887}, false, 2.0});
            task_queue_.push({ActionType::MOVE, {-3.1421162523654, -1.8610445814016, -1.6013395887048, -1.2503538761287, 1.5706217938697, 0.034732052114687}, false, 0.5});
            task_queue_.push({ActionType::GRIPPER, {}, false, 0.0});
            task_queue_.push({ActionType::MOVE, {-3.141767186515, -1.8181094818025, -1.4114477660878, -1.4830062654196, 1.5707963267949, 0.034906585039887}, false, 0.5});
            ...
            task_queue_.push({ActionType::MOVE, {-3.1489230364, -1.8788469397719, -2.6675612287, -1.7498671080, -1.5812683023, 3.1370547975}, false, 0.5});
            task_queue_.push({ActionType::MOVE, {-3.1496211681, -2.0298179201, -2.6768114737, -1.5896458827, -1.5826645657, 3.1361821329}, false, 0.5});
            task_queue_.push({ActionType::GRIPPER, {}, true, 0.0});
            task_queue_.push({ActionType::MOVE, {-3.1489230364, -1.8788469397719, -2.6675612287, -1.7498671080, -1.5812683023, 3.1370547975}, false, 0.5});
            task_queue_.push({ActionType::MOVE, {-3.139149192637, -1.6179202165987, -2.6221826681963, -2.0561723917745, -1.5709708597201, 3.1389746597118}, false, 0.5});
            ...
            task_queue_.push({ActionType::MOVE, {0.1, -1.4, 0.8, -0.8, 1.5, 0.0}, false, 2.0});
            task_queue_.push({ActionType::MOVE, {0.1, -1.4, 0.8, -0.8, 1.5, -1.57}, false, 4.0});
        }
        else if (cmd == "Y") {
            task_queue_.push({ActionType::GRIPPER, {}, true, 0.0});
            task_queue_.push({ActionType::MOVE, {-3.141767186515, -1.8181094818025, -1.4114477660878, -1.4830062654196, 1.5707963267949, 0.034906585039887}, false, 2.0});
            ...
            task_queue_.push({ActionType::MOVE, {-2.4745278134, -2.5445155164825, -1.291718179401, -2.4513149344, 0.668635636439, 3.146654108420}, false, 0.5});
            task_queue_.push({ActionType::GRIPPER, {}, false, 0.0});
            task_queue_.push({ActionType::MOVE, {-2.4783675378319, -2.4239132651697, -1.2700760966763, -2.5916394062864, 0.66514497793504, 3.1463050425702}, false, 0.5});
            ...
            task_queue_.push({ActionType::MOVE, {-3.133913204881, -1.8528415339172, -1.6104153008152, -1.2491321456523, 1.5706217938697, 1.5950564033976}, false, 0.5});
            task_queue_.push({ActionType::GRIPPER, {}, true, 0.0});
            task_queue_.push({ActionType::MOVE, {-3.141767186515, -1.8181094818025, -1.4114477660878, -1.4830062654196, 1.5707963267949, 1.6057029118348}, false, 0.5});
            task_queue_.push({ActionType::MOVE, {-3.141767186515, -1.8181094818025, -1.4114477660878, -1.4830062654196, 1.5707963267949, 0.034906585039887}, false, 1.0});
        }
            ...
            task_queue_.push({ActionType::MOVE, {-3.1421162523654, -1.8610445814016, -1.6013395887048, -1.2503538761287, 1.5706217938697, 1.6057029118348}, false, 0.5});
            task_queue_.push({ActionType::GRIPPER, {}, false, 0.0});
            task_queue_.push({ActionType::MOVE, {-3.141767186515, -1.8181094818025, -1.4114477660878, -1.4830062654196, 1.5707963267949, 1.6057029118348}, false, 0.5});
            task_queue_.push({ActionType::MOVE, {-2.8036969104037, -2.0755455464717, -1.1328932174695, -2.3038346126325, 1.1107275359692, 1.6166984861223}, false, 1.0});
            ...
            task_queue_.push({ActionType::MOVE, {-2.4783675378319, -2.5377087323998, -1.2932889757278, -2.45480559293, 0.66462137915944, 3.1466541084206}, false, 0.5});
            task_queue_.push({ActionType::GRIPPER, {}, true, 0.0});
            task_queue_.push({ActionType::MOVE, {-2.4783675378319, -2.4239132651697, -1.2700760966763, -2.5916394062864, 0.66514497793504, 3.1463050425702}, false, 0.5});
            task_queue_.push({ActionType::MOVE, {-2.739468794, -1.799958058, -1.285784060, -2.385166956, 0.9150761268, 2.026152729}, false, 1.0});
            task_queue_.push({ActionType::MOVE, {-3.141767186515, -1.8181094818025, -1.4114477660878, -1.4830062654196, 1.5707963267949, 0.034906585039887}, false, 1.0});
